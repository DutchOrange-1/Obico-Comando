...
module.exports = class AppCommand extends Command {
	...
	run(message) {
        ...
        .addFields(
            { name: 'How to enable compatibility mode: ', value: 'https://www.obico.io/docs/user-guides/streaming-compatibility-mode/#how-to-change-the-compatibility-mode-setting' },
        )
        .setTimestamp()
